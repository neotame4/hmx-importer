...
def create_mesh(mesh_data, reader) -> None:
...
#    stolen from older script version
   ...
   # else:   #     find_next_file(reader)
   #     return
    if geom_owner not in bpy.data.meshes:
